...
import PortFolioNotYetImplemented from './portfolio/PortFolioNotYetImplemented';
...
function App() {
  return (
    ...
    <div className="container mx-auto max-w-4xl">
      ...
      <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-4 p-4 md:p-4">
        <DualMomentum stock={stock} />
        <CompositeDualMomentum stock={stock} />
        <VAAAggressive stock={stock} />
        <GTAA stock={stock} />

        <PortFolioNotYetImplemented title={"가속 듀얼 모멘텀"} />
        <PortFolioNotYetImplemented title={"PAA"} />
        <PortFolioNotYetImplemented title={"DAA"} />
        <PortFolioNotYetImplemented title={"LAA"} />
      </div>
